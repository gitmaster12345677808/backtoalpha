...
if core.get_modpath("default") and mobs_mc.create_monster_egg_nodes then
	local spawn_silverfish = function(pos, oldnode, oldmetadata, digger)
		if not core.settings:get_bool("creative_mode") then
			core.add_entity(pos, "mobs_mc:silverfish")
		end
	end
	core.register_node("mobs_mc:monster_egg_stone", {
	...
	core.register_node("mobs_mc:monster_egg_cobble", {
	...
	core.register_node("mobs_mc:monster_egg_mossycobble", {
	...
	core.register_node("mobs_mc:monster_egg_stonebrick", {
	...
	core.register_node("mobs_mc:monster_egg_stone_block", {
