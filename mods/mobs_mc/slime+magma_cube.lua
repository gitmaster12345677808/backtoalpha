...
local slime_big = {
	...
	on_die = function(self, pos)
		...
		for i=1,4 do
			...
			local slime = core.add_entity(vector.add(pos, posadd), "mobs_mc:slime_small")
...
slime_small.on_die = function(self, pos)
	...
	for i=1,4 do
		...
		local slime = core.add_entity(vector.add(pos, posadd), "mobs_mc:slime_tiny")
...
mobs:spawn_specific("mobs_mc:slime_tiny", mobs_mc.spawn.solid, {"air"}, 0, core.LIGHT_MAX+1, 30, 12000, 4, smin, smax)
mobs:spawn_specific("mobs_mc:slime_small", mobs_mc.spawn.solid, {"air"}, 0, core.LIGHT_MAX+1, 30, 8500, 4, smin, smax)
mobs:spawn_specific("mobs_mc:slime_big", mobs_mc.spawn.solid, {"air"}, 0, core.LIGHT_MAX+1, 30, 10000, 4, smin, smax)
...
local magma_cube_big = {
	...
	on_die = function(self, pos)
		...
		for i=1,3 do
			posadd = {x=math.cos(angle),y=0,z=math.sin(angle)}
			posadd = vector.normalize(posadd)
			local mob = core.add_entity(vector.add(pos, posadd), "mobs_mc:magma_cube_small")
...
magma_cube_small.on_die = function(self, pos)
	...
	for i=1,4 do
		...
		local mob = core.add_entity(vector.add(pos, posadd), "mobs_mc:magma_cube_tiny")
		mob:setvelocity(dir)
		mob:setyaw(angle-math.pi/2)
		angle = angle + math.pi/2
	end
...
mobs:spawn_specific("mobs_mc:magma_cube_tiny", mobs_mc.spawn.nether, {"air"}, 0, core.LIGHT_MAX+1, 30, 15000, 4, mmin, mmax)
mobs:spawn_specific("mobs_mc:magma_cube_small", mobs_mc.spawn.nether, {"air"}, 0, core.LIGHT_MAX+1, 30, 15500, 4, mmin, mmax)
mobs:spawn_specific("mobs_mc:magma_cube_big", mobs_mc.spawn.nether, {"air"}, 0, core.LIGHT_MAX+1, 30, 16000, 4, mmin, mmax)

mobs:spawn_specific("mobs_mc:magma_cube_tiny", mobs_mc.spawn.nether_fortress, {"air"}, 0, core.LIGHT_MAX+1, 30, 11000, 4, mmin, mmax)
mobs:spawn_specific("mobs_mc:magma_cube_small", mobs_mc.spawn.nether_fortress, {"air"}, 0, core.LIGHT_MAX+1, 30, 11100, 4, mmin, mmax)
mobs:spawn_specific("mobs_mc:magma_cube_big", mobs_mc.spawn.nether_fortress, {"air"}, 0, core.LIGHT_MAX+1, 30, 11200, 4, mmin, mmax)
...
if core.settings:get_bool("log_mods") then
	core.log("action", "MC Slimes loaded")
end
