...
-- Blaze
if c("blaze_rod") then
	core.register_craftitem("mobs_mc:blaze_rod", {
	...
	if core.get_modpath("default") then
		coalcraft = core.get_craft_result({method="fuel", width=1, items={"default:coal_lump"}})
	end
	if coalcraft then
...
if c("blaze_powder") then
	core.register_craftitem("mobs_mc:blaze_powder", {
...
if c("chicken_raw") then
	core.register_craftitem("mobs_mc:chicken_raw", {
...
if c("chicken_cooked") then
	core.register_craftitem("mobs_mc:chicken_cooked", {
...
if c("feather") then
	core.register_craftitem("mobs_mc:feather", {
...
-- Cow and mooshroom
if c("beef_raw") then
	core.register_craftitem("mobs_mc:beef_raw", {
...
if c("beef_cooked") then
	core.register_craftitem("mobs_mc:beef_cooked", {
		description = S("Steak"),
...
if c("milk") then
	-- milk
	core.register_craftitem("mobs_mc:milk_bucket", {
		description = S("Milk"),
		_doc_items_longdesc = S("Milk is a food item obtained by using a bucket on a cow."),
		inventory_image = "mobs_bucket_milk.png",
		groups = { food = 3, eatable = 1 },
		on_use = core.item_eat(1, "bucket:bucket_empty"),
		stack_max = 1,
	})
end

if c("bowl") then
	core.register_craftitem("mobs_mc:bowl", {
		description = S("Bowl"),
...
if c("dragon_egg") then
	...
	--ender dragon
	core.register_node("mobs_mc:dragon_egg", {
...
-- Enderman
if c("ender_eye") then
	core.register_craftitem("mobs_mc:ender_eye", {
...
if c("ghast_tear") then
	core.register_craftitem("mobs_mc:ghast_tear", {
...
if c("iron_horse_armor") then
	core.register_craftitem("mobs_mc:iron_horse_armor", {
...
if c("gold_horse_armor") then
	core.register_craftitem("mobs_mc:gold_horse_armor", {
...
if c("diamond_horse_armor") then
	core.register_craftitem("mobs_mc:diamond_horse_armor", {
...
if c("porkchop_raw") then
	core.register_craftitem("mobs_mc:porkchop_raw", {
...
if c("porkchop_cooked") then
	core.register_craftitem("mobs_mc:porkchop_cooked", {
...
if c("carrot_on_a_stick") then
	core.register_tool("mobs_mc:carrot_on_a_stick", {
...
if c("carrot_on_a_stick") and c("stick") and c("string") and core.get_modpath("farming") then
	core.register_craft({
...
if c("carrot_on_a_stick") and c("stick") and c("string") and core.get_modpath("fishing") and core.get_modpath("farming") then
	core.register_craft({
		type = "shapeless",
		output = "mobs_mc:carrot_on_a_stick",
...
if c("rabbit_raw") then
	core.register_craftitem("mobs_mc:rabbit_raw", {
...
if c("rabbit_cooked") then
	core.register_craftitem("mobs_mc:rabbit_cooked", {
...
if c("rabbit_hide") then
	core.register_craftitem("mobs_mc:rabbit_hide", {
...
if c("rabbit_foot") then
	core.register_craftitem("mobs_mc:rabbit_foot", {
...
if c("mutton_raw") then
	core.register_craftitem("mobs_mc:mutton_raw", {
...
if c("mutton_cooked") then
	core.register_craftitem("mobs_mc:mutton_cooked", {
...
if c("shulker_shell") then
	core.register_craftitem("mobs_mc:shulker_shell", {
...
if c("magma_cream") then
	core.register_craftitem("mobs_mc:magma_cream", {
...
-- Slime
if c("slimeball") then
	core.register_craftitem("mobs_mc:slimeball", {
...
if c("spider_eye") then
	core.register_craftitem("mobs_mc:spider_eye", {
...
if c("totem") then
	...
	-- Totem of Undying
	core.register_craftitem("mobs_mc:totem", {
	...
	core.register_on_player_hpchange(function(player, hp_change)
		...
		if hp + hp_change <= 0 then
			...
			if wield:get_name() == "mobs_mc:totem" then
				...
				local pnname = core.get_node(ppos).name
				...
				-- Effects
				core.sound_play({name = "mcl_totems_totem", gain=1}, {pos=ppos, max_hear_distance=16})
...
if c("rotten_flesh") then
	core.register_craftitem("mobs_mc:rotten_flesh", {
...
if c("nether_star") then
	core.register_craftitem("mobs_mc:nether_star", {
...
if c("snowball") and core.get_modpath("default") then
	core.register_craft({
...
if c("bone") then
	core.register_craftitem("mobs_mc:bone", {
		description = S("Bone"),
