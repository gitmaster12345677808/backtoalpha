...
mobs:register_mob("mobs_mc:chicken", {
	...
	do_custom = function(self, dtime)
		...
		core.add_item(pos, mobs_mc.items.egg)
...
--spawn
mobs:spawn_specific("mobs_mc:chicken", mobs_mc.spawn.grassland, {"air"}, 9, core.LIGHT_MAX+1, 30, 17000, 3, mobs_mc.spawn_height.overworld_min, mobs_mc.spawn_height.overworld_max)

-- spawn eggs
mobs:register_egg("mobs_mc:chicken", S("Chicken"), "mobs_mc_spawn_icon_chicken.png", 0)

if core.settings:get_bool("log_mods") then
	core.log("action", "MC chicken loaded")
end
